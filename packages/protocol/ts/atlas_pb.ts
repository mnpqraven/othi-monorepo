...
export class SignatureReturns extends Message<SignatureReturns> {
  ...
  static equals(
    a: SignatureReturns | PlainMessage<SignatureReturns> | undefined,
    b: SignatureReturns | PlainMessage<SignatureReturns> | undefined,
  ): boolean {
...
export class SignatureReturn extends Message<SignatureReturn> {
  ...
  static equals(
    a: SignatureReturn | PlainMessage<SignatureReturn> | undefined,
    b: SignatureReturn | PlainMessage<SignatureReturn> | undefined,
  ): boolean {
