...
export class JadeEstimateCfg extends Message<JadeEstimateCfg> {
  ...
  static equals(
    a: JadeEstimateCfg | PlainMessage<JadeEstimateCfg> | undefined,
    b: JadeEstimateCfg | PlainMessage<JadeEstimateCfg> | undefined,
  ): boolean {
...
export class JadeEstimateResponse extends Message<JadeEstimateResponse> {
  ...
  static equals(
    a: JadeEstimateResponse | PlainMessage<JadeEstimateResponse> | undefined,
    b: JadeEstimateResponse | PlainMessage<JadeEstimateResponse> | undefined,
  ): boolean {
...
export class SimpleDate extends Message<SimpleDate> {
  ...
  static equals(
    a: SimpleDate | PlainMessage<SimpleDate> | undefined,
    b: SimpleDate | PlainMessage<SimpleDate> | undefined,
  ): boolean {
...
export class RailPassCfg extends Message<RailPassCfg> {
  ...
  static equals(
    a: RailPassCfg | PlainMessage<RailPassCfg> | undefined,
    b: RailPassCfg | PlainMessage<RailPassCfg> | undefined,
  ): boolean {
...
export class BattlePassOption extends Message<BattlePassOption> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    {
      no: 1,
      name: "battle_pass_type",
      kind: "enum",
      T: proto3.getEnumType(BattlePassType),
    },
    {
      no: 2,
      name: "current_level",
  ...
  static equals(
    a: BattlePassOption | PlainMessage<BattlePassOption> | undefined,
    b: BattlePassOption | PlainMessage<BattlePassOption> | undefined,
  ): boolean {
...
export class RewardSource extends Message<RewardSource> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "source", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    {
      ...
      name: "source_type",
      kind: "enum",
      T: proto3.getEnumType(RewardFrequency),
    },
    {
      no: 2,
      name: "jades_amount",
  ...
  static equals(
    a: RewardSource | PlainMessage<RewardSource> | undefined,
    b: RewardSource | PlainMessage<RewardSource> | undefined,
  ): boolean {
